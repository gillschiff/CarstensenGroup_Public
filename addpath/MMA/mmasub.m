...
%
%
function [xmma,ymma,lam,xsi,eta,mu,zet,s,low,upp] = ...
mmasub(m,n,iter,xval,xmin,xmax,xold1,xold2, ...
f0val,df0dx,fval,dfdx,low,upp,a0,a,c,d,beta);
%
...
asyincr = 1.15; % 1.15 wide 1.0 tight 1.05 normal
asydecr = 0.65; % 0.65 wide 0.95 tight 0.85 normal
eeen = ones(n,1);
eeem = ones(m,1);
zeron = zeros(n,1);
